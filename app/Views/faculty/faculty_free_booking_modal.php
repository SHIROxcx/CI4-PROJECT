    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="plan-section">
                ...
                <form id="freeBookingForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="freeEventDate" required>
                    </div>
            ...
            <div class="plan-section">
                ...
                <div class="equipment-grid" id="freeEquipmentGrid">
            ...
            <div class="plan-section upload-section">
                ...
                <!-- Permission Document -->
                <div class="upload-item" id="free-upload-permission">
                    ...
                    <input type="file" id="free-file-permission" class="form-control" accept=".pdf,.jpg,.jpeg,.png" onchange="handleFreeFileSelect(this, 'permission')" style="margin-bottom: 5px;">
                    <div class="file-name-display" id="free-filename-permission" style="font-size: 12px; color: var(--gray); font-style: italic;"></div>
                </div>

                <!-- Request Letter -->
                <div class="upload-item" id="free-upload-request">
                    <div class="upload-header">
                    ...
                    <input type="file" id="free-file-request" class="form-control" accept=".pdf,.jpg,.jpeg,.png" onchange="handleFreeFileSelect(this, 'request')" style="margin-bottom: 5px;">
                    <div class="file-name-display" id="free-filename-request" style="font-size: 12px; color: var(--gray); font-style: italic;"></div>
                </div>

                <!-- Approval Letter -->
                <div class="upload-item" id="free-upload-approval">
                    <div class="upload-header">
                    ...
                    <input type="file" id="free-file-approval" class="form-control" accept=".pdf,.jpg,.jpeg,.png" onchange="handleFreeFileSelect(this, 'approval')" style="margin-bottom: 5px;">
                    <div class="file-name-display" id="free-filename-approval" style="font-size: 12px; color: var(--gray); font-style: italic;"></div>
                </div>
            </div>
        </div>

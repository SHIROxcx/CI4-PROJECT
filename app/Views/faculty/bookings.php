                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= site_url('/faculty/dashboard') ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
      ...
      <div class="modal-body">
        <form id="uploadDocumentsForm" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            ...
            <div id="permissionPreview" class="file-preview-card mt-2" style="display: none;" data-file-id="">
              ...
              <div class="d-flex gap-2">
                <button type="button" class="btn btn-sm btn-success download-doc-btn" 
                        onclick="downloadDocument('permissionPreview')" 
                        style="display: none; width: 38px; height: 32px;" 
                        title="Download">
          ...
          <div class="mb-4">
            ...
            <div id="requestPreview" class="file-preview-card mt-2" style="display: none;" data-file-id="">
              <i class="fas fa-file-pdf fa-2x"></i>
              <div class="flex-grow-1 ms-3">
                <p class="mb-0 file-name"></p>
                <small class="text-muted file-size"></small>
              ...
              <div class="d-flex gap-2">
                <button type="button" class="btn btn-sm btn-success download-doc-btn" 
                        onclick="downloadDocument('requestPreview')" 
                        style="display: none; width: 38px; height: 32px;" 
                        title="Download">
                  <i class="fas fa-download"></i>
                </button>
          ...
          <div class="mb-4">
            ...
            <div id="approvalPreview" class="file-preview-card mt-2" style="display: none;" data-file-id="">
              <i class="fas fa-file-pdf fa-2x"></i>
              <div class="flex-grow-1 ms-3">
                <p class="mb-0 file-name"></p>
                <small class="text-muted file-size"></small>
              ...
              <div class="d-flex gap-2">
                <button type="button" class="btn btn-sm btn-success download-doc-btn" 
                        onclick="downloadDocument('approvalPreview')" 
                        style="display: none; width: 38px; height: 32px;" 
                        title="Download">
                  <i class="fas fa-download"></i>
                </button>
...
<!-- Receipt Upload Modal (for paid bookings) -->
<div class="modal fade" id="uploadModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-info">
          <i class="fas fa-info-circle"></i> Please upload your payment receipt. Accepted formats: PDF, JPG, PNG (Max 10MB)
        </div>
        ...
        <form id="receiptUploadForm" enctype="multipart/form-data">
          <input type="hidden" id="receiptBookingId" name="booking_id">
          ...
          <div class="mb-3">
            ...
            <div id="receiptPreview" class="file-preview-card mt-2" style="display: none;">
              <i class="fas fa-file-pdf fa-2x"></i>
              <div class="flex-grow-1 ms-3">
                <p class="mb-0 file-name"></p>
                <small class="text-muted file-size"></small>
...
<div class="modal fade" id="cancelBookingModal" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-times-circle"></i> Cancel Booking</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <input type="hidden" id="cancelBookingId">

        <!-- Refund Policy Alert (only for paid bookings) -->
        <div id="refundPolicySection" class="alert alert-warning mb-4" style="display: none;">
          <h6><i class="fas fa-info-circle"></i> Refund Policy</h6>
          <ul class="mb-0">
            <li><strong>80% refund</strong> if cancelled 15 or more working days before event</li>
            <li><strong>50% refund</strong> if cancelled 5 to 14 working days before event</li>
            <li><strong>No refund</strong> if cancelled less than 5 working days before event</li>
          </ul>
        </div>
        ...
        <div class="mb-4">
          ...
          <select class="form-select" id="cancelReason" onchange="updateCancelSubmitButtonState()">
        ...
        <!-- Cancellation Notes -->
        <div class="mb-4">
          <label for="cancelNotes" class="form-label">
            Additional Notes <span class="text-muted">(Optional)</span>
          </label>
          <textarea class="form-control" id="cancelNotes" rows="3" 
                    placeholder="Provide any additional details about your cancellation..."></textarea>
        </div>

        <!-- Cancellation Letter Upload -->
        <div class="mb-4">
          <label class="form-label">
            Cancellation Letter <span class="text-danger">*</span>
          </label>
          <div class="alert alert-info mb-3">
            <i class="fas fa-file-pdf"></i> Please upload a cancellation letter (PDF, JPG, or PNG - Max 10MB)
          </div>
          <div class="upload-area" onclick="document.getElementById('cancelLetterInput').click()">
            <i class="fas fa-cloud-upload-alt"></i>
            <span>Click to upload cancellation letter or drag and drop</span>
          </div>
          <input type="file" 
                 id="cancelLetterInput" 
                 accept=".pdf,.jpg,.jpeg,.png" 
                 hidden 
                 onchange="handleCancelLetterSelect(this)">

          <!-- File Preview -->
          <div id="cancelLetterPreview" class="file-preview-card mt-2" style="display: none;">
            <i class="fas fa-file-pdf fa-2x"></i>
            <div class="flex-grow-1 ms-3">
              <p class="mb-0" id="cancelLetterFileName"></p>
            </div>
            <div class="d-flex gap-2">
              <button type="button" class="btn btn-sm btn-danger" onclick="removeCancelLetter()">
                <i class="fas fa-times"></i>
              </button>
            </div>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="confirmCancelBtn" 
                onclick="cancelBooking()" disabled>
...
<div class="modal fade" id="extensionRequestModal" tabindex="-1">
    ...
    <script src="<?= base_url('js/faculty/bookings.js'); ?>"></script>

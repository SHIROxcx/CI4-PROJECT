      ...
      <div class="modal-body">
        <form id="uploadDocumentsForm" enctype="multipart/form-data">
          ...
          <div class="alert alert-info border-0">
            <i class="fas fa-info-circle"></i> <strong>Required Documents:</strong> Please upload the following documents. Accepted formats: PDF, JPG, PNG (Max 10MB each)
          </div>
          
          <!-- Permission Letter -->
          <div class="document-upload-group mb-4">
            <div class="document-header d-flex justify-content-between align-items-center mb-2">
              <label class="form-label fw-bold mb-0">
                <i class="fas fa-file-pdf text-danger"></i> Permission Letter
              </label>
              <span id="permission_letter_status" class="badge bg-light text-dark"></span>
            </div>
            ...
            <div id="permissionPreview" class="file-preview-card mt-3" style="display: none;" data-file-id="">
              <div class="file-icon">
                <i class="fas fa-file-alt fa-3x text-primary"></i>
              </div>
              <div class="file-info flex-grow-1">
                <p class="mb-1 file-name fw-bold"></p>
          ...
          <div class="document-upload-group mb-4">
            <div class="document-header d-flex justify-content-between align-items-center mb-2">
              <label class="form-label fw-bold mb-0">
                <i class="fas fa-file-pdf text-danger"></i> Request Letter
              </label>
              <span id="request_letter_status" class="badge bg-light text-dark"></span>
            </div>
            ...
            <div id="requestPreview" class="file-preview-card mt-3" style="display: none;" data-file-id="">
              <div class="file-icon">
                <i class="fas fa-file-alt fa-3x text-primary"></i>
              </div>
              <div class="file-info flex-grow-1">
          ...
          <div class="document-upload-group mb-4">
            <div class="document-header d-flex justify-content-between align-items-center mb-2">
              <label class="form-label fw-bold mb-0">
                <i class="fas fa-file-pdf text-danger"></i> Approval Letter
              </label>
              <span id="approval_letter_status" class="badge bg-light text-dark"></span>
            </div>
            ...
            <div id="approvalPreview" class="file-preview-card mt-3" style="display: none;" data-file-id="">
              <div class="file-icon">
                <i class="fas fa-file-alt fa-3x text-primary"></i>
              </div>
              <div class="file-info flex-grow-1">

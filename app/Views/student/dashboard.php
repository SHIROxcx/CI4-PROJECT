...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= site_url('/student/dashboard') ?>">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= site_url('/student/bookings') ?>" class="btn btn-primary btn-sm">View All</a>
                    </div>
                    <div class="card-body">
    ...
    <script src="<?= base_url('js/student/dashboard.js') ?>"></script>
</body>
</html>
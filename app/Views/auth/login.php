      ...
      <form class="auth-form" id="signupForm" method="post" action="/register">
        ...
        <div class="form-group">
          ...
          <small class="text-muted" style="display: block; margin-top: 5px;">
            <i class="fas fa-info-circle"></i>
            Use @my.cspc.edu.ph for student account | Use @cspc.edu.ph for faculty account
          </small>
        </div>
...
if (signupEmailInput) {
  signupEmailInput.addEventListener("input", function () {
    ...
    if (email.endsWith("@my.cspc.edu.ph")) {
      ...
      hintElement.innerHTML =
        '<i class="fas fa-check-circle" style="color: #2563eb;"></i> Faculty account will be created';
      ...
      hintElement.innerHTML =
        '<i class="fas fa-info-circle"></i> Use @my.cspc.edu.ph for student account | Use @cspc.edu.ph for faculty account';
      hintElement.style.color = "#64748b";
    }
  });
}

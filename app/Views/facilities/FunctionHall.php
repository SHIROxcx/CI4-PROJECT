...
<html lang="en">
  <head>
    ...
    <title>Function Hall (ACAD Building 2) - CSPC Digital Booking System</title>
    <link
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="<?= base_url('css/facilities/functionhall.css'); ?>">
    <style>
      ...
      <div class="container">
        <div class="hero-content">
          <div class="breadcrumb-nav">
            ...
            <span class="separator">•</span>
            <span>Function Hall (ACAD Building 2)</span>
          </div>
          <h1>Function Hall</h1>
          <p>
            Premium air-conditioned function hall located in ACAD Building 2, featuring modern amenities 
            and professional audio-visual equipment perfect for conferences, seminars, workshops, and special events.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="facility-details-section">
      <div class="container">
        ...
        <div class="facility-hero">
          ...
          <h2>Professional Conference & Event Venue</h2>
          <p>
            Our Function Hall in ACAD Building 2 provides a comfortable, climate-controlled environment 
            ideal for academic conferences, corporate meetings, training sessions, and special occasions. 
            Equipped with modern presentation technology and flexible seating arrangements.
          </p>
        </div>
        ...
        <div class="gallery-section">
          <h3 class="text-center mb-4" style="color: #1e293b;">Function Hall Features</h3>
          <div class="gallery-grid">
            <div class="gallery-item">
              <div class="gallery-placeholder">
                <i class="fas fa-chalkboard"></i>
              </div>
              <span>Presentation Area</span>
            </div>
            <div class="gallery-item">
              <div class="gallery-placeholder">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="footer-section">
              ...
              <a href="/avr-library">AVR Library</a>
...
let currentFacility = 'function-hall'; // ✅ MUST match database facility_key
...
async function loadFacilityData() {
  try {
    const response = await fetch("<?= base_url('api/facilities/data/function-hall') ?>");
...
async function loadEquipmentData() {
  try {
    // Use public equipment endpoint (api/equipment)
    ...
    if (Array.isArray(result)) {
      ...
      console.error("Invalid equipment response format");
      equipmentData = [];
      return;
    }

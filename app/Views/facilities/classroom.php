...
<html lang="en">
  <head>
    ...
    <title>Classrooms - Digital Booking System</title>
    <link
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="<?= base_url('css/facilities/classroom.css'); ?>">
    <style>
    ...
    <section class="hero-section">
      <div class="container">
        <div class="hero-content">
          ...
          <p>
            Well-equipped learning spaces with air conditioning, multimedia equipment, 
            and comfortable seating. Perfect for training sessions, workshops, seminars, 
            and educational activities of all types.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="facility-details-section">
      <div class="container">
        <div class="facility-hero">
          ...
          <h2>Flexible Learning Spaces</h2>
          <p>
            Our classrooms provide an ideal environment for education and training. 
            Equipped with modern technology and comfortable amenities to ensure 
        ...
        <div class="packages-section">
          <h3>Classroom Rental Packages</h3>
        ...
        <div class="charges-section">
          <div class="container">
            <h3 class="text-center mb-5" style="color: #1e293b;">Additional Services & Equipment</h3>
        ...
        <div class="gallery-section">
          <h3 class="text-center mb-4" style="color: #1e293b;">Classroom Facilities Gallery</h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="footer-section">
              ...
              <p style="color: #94a3b8; line-height: 1.6;">
                Modern learning spaces designed for effective education and training. 
                Equipped with the latest technology to support your educational needs.
              </p>
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="footer-section">
              <h5>Room Types</h5>
              <a href="#">Lecture Rooms</a>
              <a href="#">Computer Labs</a>
              <a href="#">Seminar Rooms</a>
              <a href="#">Workshop Spaces</a>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="footer-section">
              ...
              <a href="mailto:classrooms@cspc.edu.ph">
                <i class="fas fa-envelope" style="margin-right: 8px;"></i>
                classrooms@cspc.edu.ph
              </a>
              <a href="#">
                <i class="fas fa-map-marker-alt" style="margin-right: 8px;"></i>
                CSPC Campus, Philippines
              </a>
            </div>
          </div>
        </div>
...
let currentFacility = 'classrooms'; // ✅ MUST match database facility_key
...
async function loadFacilityData() {
  try {
    const response = await fetch("<?= base_url('api/facilities/data/classrooms') ?>");
...
function renderPackages() {
  ...
  facilityData.plans.forEach((plan, index) => {
    ...
    const isMostPopular = index === 1; // Mark second plan as most popular
  ...
  addonsData.forEach((addon) => {
    html += `
      <div class="service-item">
        <span class="service-description">${addon.name}</span>
        <span class="service-price">₱${parseFloat(addon.price).toLocaleString()}</span>
      </div>
    `;
  });
...
async function loadEquipmentData() {
  try {
    ...
    console.log("API Success:", result.success || true);
...
function openBookingModal(packageName) {
  ...
  const additionalHoursRate = facilityData.additional_hours_rate || 300;
    ...
    try {
      const conflictCheck = await fetch("<?= base_url('api/bookings/checkDateConflict') ?>", {
        ...
        body: JSON.stringify({
          ...
          duration: selectedPlan?.duration?.match(/\d+/)?.[0] || 2
        })
      });

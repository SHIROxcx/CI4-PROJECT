...
<html lang="en">
  <head>
    ...
    <title>University Auditorium - CSPC Digital Booking System</title>
    <link
    ...
    <section class="hero-section">
      <div class="container">
        <div class="hero-content">
          ...
          <h1>University Auditorium</h1>
          <p>
            Premier performance and event venue equipped with professional-grade audio-visual systems, 
            advanced stage lighting, and comprehensive event solutions for all your theatrical, 
            ceremonial, and large-scale gathering needs.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="facility-details-section">
      <div class="container">
        ...
        <div class="facility-hero">
          ...
          <h2>World-Class Performance Venue</h2>
          <p>
            Our University Auditorium offers a state-of-the-art facility perfect for theatrical productions, 
            concerts, graduations, conferences, and large-scale events. With professional-grade equipment, 
            flexible seating arrangements, and comprehensive technical support, we can accommodate events of any scale.
          </p>
        </div>
        ...
        <div class="gallery-section">
          ...
          <div class="gallery-grid">
            ...
            <div class="gallery-item">
              ...
              <span>Stage Lighting System</span>
            </div>
            <div class="gallery-item">
              <div class="gallery-placeholder">
...
let currentFacility = 'auditorium'; // Changed to auditorium
const MAINTENANCE_FEE = 2000;
let HOURLY_RATE = 1000; // Auditorium hourly rate (will be updated from database)
...
async function loadFacilityData() {
  try {
    const response = await fetch("<?= base_url('api/facilities/data/auditorium') ?>");
    const data = await response.json();
    facilityData = data.facility || data; // Extract facility object from response
    // Update hourly rate from database
    ...
    console.log("Hourly rate set to:", HOURLY_RATE);
    
    // Render packages with dynamic data
    renderPackages();
  } catch (error) {
...
async function loadAddonsData() {
  try {
    ...
    // Render charges with dynamic data
    renderCharges();
  } catch (error) {
...
function openBookingModal(packageName) {
  ...
  // Find the plan by name directly

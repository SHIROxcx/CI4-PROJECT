...
async function loadAddonsData() {
  try {
    ...
    let addonsArray = data;
    if (data.addons && Array.isArray(data.addons)) {
      addonsArray = data.addons;
    } else if (!Array.isArray(data)) {
      console.warn("Unexpected addons response format:", data);
      addonsArray = [];
    }
...
async function loadEquipmentData() {
  try {
    ...
    console.log("Equipment API Debug:", result.success || "array response");

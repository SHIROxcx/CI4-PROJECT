                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= site_url('/user/dashboard') ?>"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= site_url('/user/attendance') ?>">
                        ...
                        <div class="col-md-5">
                            <div class="card scanner-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <label><small>Or manually enter QR code:</small></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm" id="manualQRInput" placeholder="Enter QR code..." autocomplete="off">
                                            <button class="btn btn-primary btn-sm" onclick="submitManualQR()">
...
<script src="<?= base_url('js/dashboard/attendance.js'); ?>"></script>
</body>
</html>
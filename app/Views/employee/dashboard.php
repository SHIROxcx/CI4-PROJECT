...
<head>
    ...
    <title>Employee Dashboard | CSPC Digital Booking System</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= site_url('/employee/dashboard') ?>">
                            <i class="fas fa-tachometer-alt"></i> Overview
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="<?= site_url('/employee/book') ?>">

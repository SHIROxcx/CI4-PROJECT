...
public function delete($id = null)
{
    try {
        ...
        // ⚠️ REMOVE THE STATUS CHECK - Allow deletion of any status
...
public function deleteFile($fileId)
{
    try {
        $db = \Config\Database::connect();
        $file = $db->table('booking_files')->where('id', $fileId)->get()->getRowArray();
        ...
        $db->table('booking_files')->where('id', $fileId)->delete();
...
public function getBookingsList()
{
    ...
    public function generateFacilityRentalReport()
    {
        try {
            ...
            // Load template
            $templatePath = ROOTPATH . 'public/assets/templates/report_summary.xlsx';

...
class Users extends BaseController
{
    ...
    public function getUsers()
    {
        try {
            ...
            if ($users === false) {
                return $this->response->setJSON(['error' => 'Failed to fetch users'])->setStatusCode(500);
            }
            ...
            return $this->response->setJSON(['error' => 'An error occurred while fetching users'])->setStatusCode(500);
        }
    }

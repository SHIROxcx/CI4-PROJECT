    ...
    public function updateSignatories()
    {
        ...
        try {
            ...
            try {
                ...
                log_message('info', 'Signatories saved to database: ' . $templateName . ' by ' . (session('full_name') ?? 'System'));
                ...
                log_message('error', 'Exception in database save: ' . $e->getMessage());
                return $this->response->setStatusCode(500)->setJSON([
                    'success' => false,
                    'message' => 'Failed to save signatories to database',
                    'details' => $e->getMessage()
                ]);
            }
